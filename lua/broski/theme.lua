...
function M.setup()
  ...
  apply_highlights(M.polish_hl.defaults)
  apply_highlights(M.polish_hl.treesitter)
  apply_highlights(M.polish_hl.nvimtree)
  apply_highlights(M.polish_hl.telescope)
end
