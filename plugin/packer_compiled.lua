...
_G.packer_plugins = {
  ...
  ["compline.theme"] = {
    loaded = true,
    path = "/home/codeman/.local/share/nvim/site/pack/packer/start/compline.theme",
    url = "https://github.com/jblais493/compline.theme"
  },
  ["copilot.lua"] = {
    loaded = true,
  ...
  ["vim-bufferline"] = {
    loaded = true,
    path = "/home/codeman/.local/share/nvim/site/pack/packer/start/vim-bufferline",
