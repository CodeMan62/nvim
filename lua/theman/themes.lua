-- Theme plugins extracted from packer.lua to keep the main file slim.
-- This module exports a function that receives the `use` helper.
return function(use)
    use({
    ...
    use({
        "RRethy/base16-nvim",
        disable = true, -- disabled in the original lazy spec
        config = function()
    ...
    -- Additional themes originally in packer.lua
    use({
        'rose-pine/neovim',
        as = 'rose-pine',
        config = function()
